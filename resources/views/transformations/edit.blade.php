...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body bg-gradient-primary text-white p-4">
                    <div class="d-flex align-items-center">
                        <a href="{{ route('transformations.show', $transformation) }}" class="btn btn-light btn-sm me-3">
            ...
            <!-- Form -->
            <form action="{{ route('transformations.update', $transformation) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <select name="waste_item_id" class="form-select @error('waste_item_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $wasteItem->id }}" {{ old('waste_item_id', $transformation->waste_item_id) == $wasteItem->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Describe the transformation process and final product..." required>{{ old('description', $transformation->description) }}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $transformation->price) }}" placeholder="0.00">
                                @error('price')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                    <option value="planned" {{ old('status', $transformation->status) == 'planned' ? 'selected' : '' }}>Planned</option>
                                    <option value="in_progress" {{ old('status', $transformation->status) == 'in_progress' ? 'selected' : '' }}>In Progress</option>
                                    <option value="completed" {{ old('status', $transformation->status) == 'completed' ? 'selected' : '' }}>Completed</option>
                                    <option value="published" {{ old('status', $transformation->status) == 'published' ? 'selected' : '' }}>Published</option>
                                </select>
                                @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="time_spent_hours" class="form-control @error('time_spent_hours') is-invalid @enderror" value="{{ old('time_spent_hours', $transformation->time_spent_hours) }}" placeholder="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" name="materials_cost" class="form-control @error('materials_cost') is-invalid @enderror" value="{{ old('materials_cost', $transformation->materials_cost) }}" placeholder="0.00">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="{{ route('transformations.show', $transformation) }}" class="btn btn-outline-secondary">
